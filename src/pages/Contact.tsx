          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">esrael.cv@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-gray-900 text-white p-4 rounded-lg hover:bg-gray-800 transition-colors duration-200"
                  aria-label="GitHub"
                >
                ...
                <a
                  href="#"
                  className="bg-blue-400 text-white p-4 rounded-lg hover:bg-blue-500 transition-colors duration-200"
                  aria-label="Twitter"
                >
